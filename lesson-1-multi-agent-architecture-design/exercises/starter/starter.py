...
def create_diagram(title, nodes, edges, node_labels=None, node_types=None, edge_labels=None):
    ...
    pos["Feedback Collector"] = (horizontal_spacing, 0),
    pos["Cultural Sensitivity Checker"] = (3*horizontal_spacing, -vertical_spacing)
...
def extended_uluru_exercise():
    ...
    edges = [
        ...
        ("Cultural Sensitivity Checker", "Knowledge Base Lookup"),
        ...
        ("Language Identification", "Translation Verification Agent"),
        ("Translation Verification Agent", "Visitor Input"),
